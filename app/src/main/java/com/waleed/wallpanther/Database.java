...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String CREATE = "CREATE TABLE " + TABLE_NAME + "(" + ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + TITLE + " TEXT NOT NULL, " + AUTHOR + " TEXT NOT NULL, " + MAIN_LINK + " TEXT NOT NULL, " + THUMBNAIL_LINK + " TEXT NOT NULL, " + DATE_CREATED + " TEXT NOT NULL);";
    ...
    public ArrayList<Entry> getAllWallpapers(){
        String[] cols = new String[] { ID, TITLE, AUTHOR, MAIN_LINK, THUMBNAIL_LINK, DATE_CREATED };
        ...
        if (cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                backgrounds.add(new Entry(cursor.getString(1), cursor.getString(3),cursor.getString(4), cursor.getString(2), cursor.getString(5)));
                cursor.moveToNext();
            }
        }
        return backgrounds;
    ...
    public void insertWallpaper(Entry e){
        ...
        contentValue.put(DATE_CREATED, e.getDate_created());
